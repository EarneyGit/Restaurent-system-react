...
export default function DineInOrders() {
  ...
  // Mock data for orders - filtered for Dine-in orders only
  const orders = [
    { 
      id: 1208, 
      deliveryDate: "N/A", 
  ...
  return (
    <div className="w-full px-6 py-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-medium">Dine-in Orders</h1>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {orders.map(order => (
                  <tr key={order.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">#{order.id % 10 + 1}</td>
