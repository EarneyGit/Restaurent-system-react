              ...
              {groupedOrders[column.id]?.map((order: any) => (
                <div key={order.id} className="bg-white p-3 rounded-lg mb-2 shadow-sm">
                  ...
                  <div className="text-sm text-gray-600 mb-1">
                    ...
                    <div className="flex justify-between">
                      <span>Scheduled:</span>
                      <span className="text-purple-600">{order.deliveryDate}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Price:</span>
...
export default function ScheduledOrders() {
  ...
  // Mock data for orders - scheduled orders with future delivery dates
  const orders = [
    { 
      id: 1250, 
      deliveryDate: "30-04-2025 14:30", 
  ...
  return (
    <div className="w-full px-6 py-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-medium">Scheduled Orders</h1>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {orders.map(order => (
                  <tr key={order.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-purple-600 font-medium">{order.deliveryDate}</td>
